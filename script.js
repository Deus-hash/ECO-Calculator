    ...
    const DB = [
      {id:'eps30',name:'Пенополистирол EPS',rho:30,lam:0.039,F:2.55,e:88.6,color:'#d4c8a0',tex:'tex-insulation'},
      {id:'eps15',name:'Пенополистирол EPS',rho:15,lam:0.031,F:2.55,e:88.6,color:'#d8cca8',tex:'tex-insulation'},
      {id:'eps30b',name:'Пенополистирол EPS (плиты)',rho:30,lam:0.049,F:2.55,e:88.6,color:'#d4c8a0',tex:'tex-insulation'},
      {id:'eps20',name:'Пенополистирол EPS (плиты)',rho:20,lam:0.051,F:2.55,e:88.6,color:'#d8cca8',tex:'tex-insulation'},
      {id:'eps15b',name:'Пенополистирол EPS (плиты)',rho:15,lam:0.053,F:2.55,e:88.6,color:'#dcd0b0',tex:'tex-insulation'},
      {id:'eps10',name:'Пенополистирол EPS (плиты)',rho:10,lam:0.057,F:2.55,e:88.6,color:'#dcd0b0',tex:'tex-insulation'},
      {id:'eps5',name:'Пенополистирол EPS (плиты)',rho:5,lam:0.072,F:2.55,e:88.6,color:'#e0d4b8',tex:'tex-insulation'},
      {id:'eps-facade',name:'Пенополистирол фасадный',rho:16,lam:0.048,F:2.55,e:88.6,color:'#d4c8a0',tex:'tex-insulation'},
      {id:'xps30',name:'Экструзионный XPS',rho:30,lam:0.033,F:3.48,e:101.5,color:'#c8c4a8',tex:'tex-insulation'},
      {id:'xps40',name:'Экструзионный XPS',rho:40,lam:0.035,F:3.48,e:101.5,color:'#c4c0a4',tex:'tex-insulation'},
      {id:'xps35',name:'Экструзионный XPS (плиты)',rho:35,lam:0.033,F:3.48,e:101.5,color:'#c8c4a8',tex:'tex-insulation'},
      {id:'xps35b',name:'Экструзионный XPS',rho:38,lam:0.036,F:3.48,e:101.5,color:'#c4c0a4',tex:'tex-insulation'},
      {id:'pir40',name:'Полиизоцианурат PIR',rho:40,lam:0.022,F:3.48,e:101.5,color:'#c0b898',tex:'tex-insulation'},
      {id:'pir35',name:'Полиизоцианурат PIR',rho:35,lam:0.022,F:3.48,e:101.5,color:'#c4bc9c',tex:'tex-insulation'},
      {id:'pir30',name:'Полиизоцианурат PIR',rho:30,lam:0.022,F:3.48,e:101.5,color:'#c8c0a0',tex:'tex-insulation'},
      {id:'pir20',name:'Полиизоцианурат PIR',rho:20,lam:0.021,F:3.48,e:101.5,color:'#ccc4a8',tex:'tex-insulation'},
      ...
      {id:'pur80',name:'Плиты ППУ',rho:80,lam:0.047,F:3.48,e:101.5,color:'#b8ac88',tex:'tex-insulation'},
      {id:'pur60',name:'Плиты ППУ',rho:60,lam:0.04,F:3.48,e:101.5,color:'#c0b490',tex:'tex-insulation'},
      {id:'pur40',name:'Плиты ППУ',rho:40,lam:0.033,F:3.48,e:101.5,color:'#c8bc98',tex:'tex-insulation'},
      {id:'mw160',name:'Минвата каменная',rho:160,lam:0.047,F:1.05,e:16.8,color:'#b8a888',tex:'tex-insulation'},
      {id:'mw140',name:'Минвата каменная',rho:140,lam:0.046,F:1.05,e:16.8,color:'#bcac8c',tex:'tex-insulation'},
      {id:'mw120',name:'Минвата каменная',rho:120,lam:0.046,F:1.05,e:16.8,color:'#c0b090',tex:'tex-insulation'},
      {id:'mw80',name:'Минвата каменная ρ=80',rho:80,lam:0.045,F:1.05,e:16.8,color:'#c8b898',tex:'tex-insulation'},
      {id:'mw60',name:'Минвата каменная ρ=60',rho:60,lam:0.044,F:1.05,e:16.8,color:'#ccbc9c',tex:'tex-insulation'},
      {id:'mw50',name:'Минвата каменная ρ=50',rho:50,lam:0.043,F:1.05,e:16.8,color:'#d0c0a0',tex:'tex-insulation'},
      {id:'mw40',name:'Минвата каменная ρ=40',rho:40,lam:0.037,F:1.05,e:16.8,color:'#d4c4a4',tex:'tex-insulation'},
      ...
      {id:'cellulose50',name:'Целлюлозное волокно',rho:50,lam:0.04,F:0.98,e:20.0,color:'#c0b090',tex:'tex-sand'},
      {id:'ecowool60',name:'Эковата',rho:60,lam:0.049,F:0.98,e:20.0,color:'#bcac8c',tex:'tex-sand'},
      {id:'ecowool50',name:'Эковата',rho:50,lam:0.045,F:0.98,e:20.0,color:'#c0b090',tex:'tex-sand'},
      {id:'ecowool40',name:'Эковата',rho:40,lam:0.04,F:0.98,e:20.0,color:'#c4b494',tex:'tex-sand'},
      ...
      {id:'gypsum1350',name:'Плиты гипсовые пазогребневые ρ=1350',rho:1350,lam:0.56,F:0.12,e:1.8,color:'#c0b8b0',tex:'tex-plaster'},
      {id:'gypsum1100',name:'Плиты гипсовые пазогребневые ρ=1100',rho:1100,lam:0.41,F:0.12,e:1.8,color:'#c4bcb4',tex:'tex-plaster'},
      {id:'gyprock1050',name:'Гипсокартон ρ=1050',rho:1050,lam:0.36,F:0.38,e:6.75,color:'#c0b8b0',tex:'tex-plaster'},
      ...
      {id:'sand1600',name:'Песок строительный',rho:1600,lam:0.58,F:0.005,e:0.083,color:'#c8c0a8',tex:'tex-sand'},
      {id:'rc2500',name:'Железобетон сборный',rho:2500,lam:2.04,F:0.159,e:1.11,color:'#7a7a7a',tex:'tex-concrete'},
      ...
      {id:'cer-block1600',name:'Керамические блоки ρ=1600',rho:1600,lam:0.63,F:0.24,e:3.0,color:'#b07050',tex:'tex-brick'},
      {id:'cer-block800',name:'Керамические блоки ρ=800',rho:800,lam:0.18,F:0.24,e:3.0,color:'#b88060',tex:'tex-brick'},
      {id:'cpr1800',name:'Раствор цементно-песчаный',rho:1800,lam:0.93,F:0.208,e:1.33,color:'#b0a898',tex:'tex-plaster'},
      ...
      {id:'cplaster1800',name:'Штукатурка цементно-песчаная',rho:1800,lam:0.93,F:0.208,e:1.33,color:'#b0a898',tex:'tex-plaster'},
      {id:'gplaster1100',name:'Штукатурка гипсовая ρ=1100',rho:1100,lam:0.27,F:0.12,e:1.8,color:'#c0b8b0',tex:'tex-plaster'},
      {id:'gplaster1000',name:'Штукатурка гипсовая ρ=1000',rho:1000,lam:0.25,F:0.12,e:1.8,color:'#c4bcb4',tex:'tex-plaster'},
      {id:'clay-brick1900',name:'Кирпич глиняный на ЦПР ρ=1900',rho:1900,lam:0.85,F:0.24,e:3.0,color:'#b85a3a',tex:'tex-brick'},
      {id:'clay-brick1800',name:'Кирпич глиняный на ЦПР ρ=1800',rho:1800,lam:0.81,F:0.24,e:3.0,color:'#ba5c3c',tex:'tex-brick'},
      {id:'clay-brick1700',name:'Кирпич глиняный на ЦШР ρ=1700',rho:1700,lam:0.76,F:0.24,e:3.0,color:'#bc5e3e',tex:'tex-brick'},
      {id:'cer-brick1600',name:'Кирпич керамический пустотный ρ=1600',rho:1600,lam:0.64,F:0.24,e:3.0,color:'#b87048',tex:'tex-brick'},
      {id:'cer-brick1400',name:'Кирпич керамический пустотный ρ=1400',rho:1400,lam:0.58,F:0.24,e:3.0,color:'#ba784e',tex:'tex-brick'},
      {id:'cer-brick1200',name:'Кирпич керамический пустотный ρ=1200',rho:1200,lam:0.52,F:0.24,e:3.0,color:'#bc8054',tex:'tex-brick'},
      {id:'sil-brick1800',name:'Кирпич силикатный на ЦПР ρ=1800',rho:1800,lam:1.05,F:0.24,e:3.0,color:'#c8c0b0',tex:'tex-brick'},
      {id:'sil-brick1960',name:'Кирпич силикатный на ЦПР ρ=1960',rho:1960,lam:1.48,F:0.24,e:3.0,color:'#c4bcac',tex:'tex-brick'},
      {id:'sil-brick1500',name:'Кирпич силикатный пустотный ρ=1500',rho:1500,lam:0.81,F:0.24,e:3.0,color:'#ccc4b4',tex:'tex-brick'},
      {id:'sil-brick1400',name:'Кирпич силикатный 14-пустотный ρ=1400',rho:1400,lam:0.76,F:0.24,e:3.0,color:'#d0c8b8',tex:'tex-brick'},
      {id:'hardwood',name:'Пиломатериалы лиственных',rho:650,lam:0.14,F:0.46,e:8.5,color:'#7a5a3a',tex:'tex-wood'},
      {id:'pine',name:'Сосна/ель поперёк волокон',rho:500,lam:0.18,F:0.46,e:8.5,color:'#8a6a4a',tex:'tex-wood'},
      {id:'oak',name:'Дуб поперёк волокон',rho:700,lam:0.23,F:0.46,e:8.5,color:'#6a4a2a',tex:'tex-wood'},
      ...
      {id:'rebar-steel',name:'Сталь стержневая арматурная',rho:7850,lam:58,F:1.37,e:20.1,color:'#7a7a80',tex:'tex-concrete'},
      {id:'mesh-steel',name:'Сварная сетка',rho:7850,lam:58,F:1.37,e:20.1,color:'#7a7a80',tex:'tex-concrete'},
      ...
      {id:'wire-steel',name:'Проволока стальная',rho:7850,lam:58,F:1.37,e:20.1,color:'#7a7a80',tex:'tex-concrete'},
      ...
      {id:'glass2500',name:'Стекло оконное',rho:2500,lam:0.76,F:0.85,e:15.0,color:'#8ab8c0',tex:'tex-sand'},
      ...
      {id:'paint-solvent',name:'Краска на основе растворителя',rho:1000,lam:0.2,F:3.13,e:97.0,color:'#b0a898',tex:'tex-plaster'},
      {id:'paint-acrylic',name:'Акриловая краска (водная)',rho:1000,lam:0.2,F:2.12,e:59.0,color:'#b8b0a8',tex:'tex-plaster'},
